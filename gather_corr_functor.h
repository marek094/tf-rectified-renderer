...
#ifndef TENSORFLOW_CORE_KERNELS_gather_corr_functor_H_
#define TENSORFLOW_CORE_KERNELS_gather_corr_functor_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_gather_corr_functor_H_
