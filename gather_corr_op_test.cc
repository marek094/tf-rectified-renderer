...
class GatherCorrOpTest : public OpsTestBase {
 protected:
  void MakeOp(DataType data_type, DataType index_type) {
    TF_ASSERT_OK(NodeDefBuilder("myop", "GatherCorr")
...
TEST_F(GatherCorrOpTest, ScalarIndices) {
...
TEST_F(GatherCorrOpTest, ScalarIndices_Complex) {
...
TEST_F(GatherCorrOpTest, Simple_TwoD32_Axis0) {
  MakeOp(DT_FLOAT, DT_INT32);
...
TEST_F(GatherCorrOpTest, Simple_TwoD32_Axis1) {
  MakeOp(DT_FLOAT, DT_INT32);
...
TEST_F(GatherCorrOpTest, ZeroSize_TwoD32) {
  MakeOp(DT_FLOAT, DT_INT32);
...
TEST_F(GatherCorrOpTest, Simple_TwoD64) {
...
TEST_F(GatherCorrOpTest, HighRank) {
  MakeOp(DT_FLOAT, DT_INT32);
...
TEST_F(GatherCorrOpTest, Error_IndexOutOfRange) {
  MakeOp(DT_FLOAT, DT_INT32);
